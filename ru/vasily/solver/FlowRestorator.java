...
public class FlowRestorator {
	...
	public FlowRestorator(Fetcher fetcher, double nu, double omega, int xRes,
			int varNum) {
		this.nu = nu;
	...
	public void setRestoredUL(double[] uL, int i) {
	...
	private void set_wave_delta(double[] result, int i) {
		...
		fetcher.setU(delta_plus_half, i);
		fetcher.setU(delta_minus_half, i - 1);
	...
	private void set_d_wave_delta(double[] result, int i) {
		...
		fetcher.setU(delta_plus_half, i);
		fetcher.setU(delta_plus_3_2, i + 1);
